...
enum URL {
  userLogin = '/tutor/index/user/login',
  userRegister = '/tutor/index/user/register',
  detail = '/tutor/index/user/info',
  updateUserPwd = '/tutor/index/user/updatePwd',
  updateUserInfo = '/tutor/index/user/update',
}
interface LoginRes {
  token: string;
}
...
const updateUserInfoApi = async (params: any, data: any) =>
  post<any>({ url: URL.updateUserInfo, params: params, data: data, headers: { 'Content-Type': 'multipart/form-data;charset=utf-8' } });
