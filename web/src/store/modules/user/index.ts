...
import { USER_ID, USER_NAME, USER_TOKEN, USER_Location, ADMIN_USER_ID, ADMIN_USER_NAME, ADMIN_USER_TOKEN } from '/@/store/constants';
    ...
    async login(loginForm) {
      ...
      if (result.code === 0) {
        this.$patch((state) => {
          ...
          state.user_location = result.data.location;
