        ...
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="24">
                <a-form-item label="通知对象" name="status">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.status">
                    <a-select-option key="0" value="0">全部用户</a-select-option>
                    <a-select-option key="1" value="1">家教用户</a-select-option>
                    <a-select-option key="2" value="2">需求用户</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
