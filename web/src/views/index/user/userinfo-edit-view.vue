...
<script setup>
  ...
  const submit = () => {
    ...
    if (tData.form.nickname) {
      if (/^[\u4e00-\u9fa5_a-zA-Z]{2,10}$/.test(tData.form.nickname)) {
    ...
    if (tData.form.email) {
      if (/^([a-zA-Z0-9]+[_|_|.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|_|.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3}$/.test(tData.form.email)) {
    ...
    if (tData.form.mobile) {
      if (/^1[3|4|5|6|7|8|9][0-9]\d{8}$/.test(tData.form.mobile)) {
