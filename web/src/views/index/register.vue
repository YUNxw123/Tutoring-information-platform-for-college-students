    ...
    <div class="tel-regist-page pc-style">
      ...
      <div class="regist-padding">
        <div class="common-input">
          <img :src="NameIcon" class="left-icon" />
          <div class="input-view">
            <input placeholder="请输入用户名/邮箱/手机号" v-model="tData.loginForm.username" type="text" class="input" />
            <p class="err-view"> </p>
          </div>
        </div>
      </div>
      <div class="regist-padding">
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="请输入手机号" v-model="tData.loginForm.mobile" type="text" class="input" />
            <p class="err-view"> </p>
          </div>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  import NameIcon from '/@/assets/images/register-name.svg';
