            ...
            <div class="thing-infos">
              ...
              <div class="thing-info-box">
                ...
                <div class="aa">
                  ...
                  <div class="translators flex-view" style="">
                    <span>学校：</span>
                    <span class="name">{{ detailData.school }}</span>
                  </div>
                </div>
                <div class="bb" style="float: right">
                  <div class="translators flex-view" style="">
                    <span>科目：</span>
                  ...
                  <div class="translators flex-view" style="">
                    <span>在校年级：</span>
                    <span class="name">{{ detailData.grade }}</span>
                  </div>
                </div>
                ...
                <button class="buy-btn" @click="handleOrder(detailData)" style="clear: right">
                  <img :src="AddIcon" />
                  <span>立即联系</span>
                </button>
              </div>
        ...
        <div class="thing-content-view flex-view">
          <div class="main-content">
            ...
            <div class="thing-intro" :class="selectTabIndex == 0 ? '' : 'hide'">
              <p class="text" style="" v-if="detailData.cert">{{ detailData.cert }}</p>
              <p class="text" style="" v-else>暂无数据</p>
            </div>
            <!--评论-->
            <div class="thing-comment" :class="selectTabIndex == 2 ? '' : 'hide'">
              <div class="title">发表新的评论</div>
              <!--              <div>{{ selectTabIndex }}</div>-->
...
<script setup>
  ...
  let thingId = ref('');
  let detailData = ref({});
  let tabUnderLeft = ref(24);
  let tabData = ref(['所获证书', '简介', '评论']);
  ...
  const selectTab = (index) => {
    ...
    if (index == 2) {
      tabUnderLeft.value = 64 + 40 + 38;
    } else {
      tabUnderLeft.value = 24 + 68 * index;
    }
  };
  ...
  const getThingDetail = () => {
    detailApi({ id: thingId.value })
      .then((res) => {
        ...
        detailData.value.sex = 'F' ? '女' : '男';
        if (detailData.value.grade) {
          if (detailData.value.grade == 1) {
            detailData.value.grade = '大一';
          } else if (detailData.value.grade == 2) {
            detailData.value.grade = '大二';
          } else if (detailData.value.grade == 3) {
            detailData.value.grade = '大三';
          } else {
            detailData.value.grade = '大四';
          }
        }
