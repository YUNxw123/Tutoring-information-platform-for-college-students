...
urlpatterns = [
    ...
    path('admin/order/auditlist', views.admin.order.auditlist_api),
    ...
    path('admin/order/audit_pass', views.admin.order.audit_pass),
path('admin/thing/list', views.admin.thing.list_api),
    path('admin/thing/auditlist', views.admin.thing.auditlist_api),
    ...
    path('admin/thing/audit_pass', views.admin.thing.audit_pass),
    ...
    path('index/classification/countlist', views.index.classification.countlist_api),
    path('index/tag/list', views.index.tag.list_api),
    path('index/tag/countlist', views.index.tag.countlist_api),
    path('index/ad/list', views.index.ad.list_api),
    ...
    path('index/comment/orderlist', views.index.comment.orderlist_api),
    ...
    path('index/order/detail', views.index.order.detail),
    path('index/order/increaseWishCount', views.index.order.increaseWishCount),
    path('index/order/addWishUser', views.index.order.addWishUser),
    path('index/order/removeWishUser', views.index.order.removeWishUser),
    path('index/order/getWishorderList', views.index.order.getWishorderList),
    path('index/order/increaseRecommendCount', views.index.order.increaseRecommendCount),
    path('index/order/listUserorder', views.index.order.list_user_order_api),
    path('index/order/create', views.index.order.create),
    path('index/order/update', views.index.order.update),
    path('index/order/delete', views.index.order.delete),
]
